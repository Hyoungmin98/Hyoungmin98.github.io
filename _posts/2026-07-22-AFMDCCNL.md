...
- TO: \$$\mathrm{TO}=\frac{1}{479}\sum_{h=1}^{479}\left\lVert \widehat{\mathbf{w}}_{h+1}-\widehat{\mathbf{w}}_{h}^{\mathrm{hold}}\right\rVert_{1}$$   
- GL: \$$\mathrm{GL}=\frac{1}{480}\sum_{h=1}^{480}\left\lVert \widehat{\mathbf{w}}_{h}\right\rVert_{1}$$  
