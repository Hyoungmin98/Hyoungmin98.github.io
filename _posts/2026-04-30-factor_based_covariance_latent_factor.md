...
- ASYM  
    ...
    - $\mathrm{ASYM}=\frac{1}{b(b-1)}{tr}\left(\hat{S}_t^{\,b}\hat{\Sigma}_t^{-b}\right)-\frac{1}{b-1}\operatorname{tr}\left[\hat{\Sigma}_t^{\,1-b}\left(\hat{\Sigma}_t-\hat{S}_t\right)\right]$    
    - b = 3으로 설정   
