...
**해당 게시글은 Kelly et al.,(2019)의 "Characteristics are covariances: A unified model of risk and return" 논문을 리뷰한 글입니다. 본 게시물에서 인용한 논문 및 자료에 대한 상세 정보는 아래의 링크를 통해 확인하실 수 있습니다.  
[Kelly et al.,(2019)](https://doi.org/10.1016/j.jfineco.2019.05.001)**   
...
$Predictive \, R^2 = 1 - \frac{\sum_{i,t}(r_{i,t+1} - z_{i,t}'(\hat\Gamma_{\alpha} + \hat\Gamma_{\beta}\hat \lambda))^2}{\sum_{i,t}r^2_{i,t+1}}$  
